...
eeprom char datoguardar;
void checa_boton(void); //Aquí se declaran todas las funciones que se utilizarán
...
while (1)
      ...
      // Place your code here
         ...
         datoguardar=var; //Se graba la eeprom con el valor de var
      }
}
...
void checa_boton(void)
{
    if(boton==0)
        ...
        botona=1;
    if((botonp==1)&&(botona==0))//Cambio de flanco de 1 a 0
    {
        var++; //Incrementa la variable
        if(var>=10)
            var=0;
