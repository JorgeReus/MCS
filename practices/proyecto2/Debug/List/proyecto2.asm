...
; 0000 0040 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
;	i -> R16,R17
;	completed -> R15.0
	CLR  R15
	RCALL SUBOPT_0x0
...
_0x3:
; 0000 00A4     {
; 0000 00A5         // Se borran las instrucciones y se guardan una por una las nuevas
; 0000 00A6          if(b_clr_and_save == 0) {
	SBIC 0x16,0
	RJMP _0x6
; 0000 00A7              b_clr_and_save_a = 0;
	CLT
	RJMP _0x37
; 0000 00A8          } else {
_0x6:
; 0000 00A9              b_clr_and_save_a = 1;
	SET
_0x37:
	BLD  R2,1
; 0000 00AA          }
; 0000 00AB          if((b_clr_and_save_p == 1) && (b_clr_and_save_a == 0)) {// Cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0x9
	SBRS R2,1
	RJMP _0xA
...
; 0000 00AC             // Borrado
; 0000 00AD 
; 0000 00AE             for (i = 0; i < MEM_SIZE; i++) {
	RCALL SUBOPT_0x0
_0xC:
	__CPWRN 16,17,10
	BRGE _0xD
; 0000 00AF                 memory[i] = 0;
	RCALL SUBOPT_0x1
	LDI  R30,LOW(0)
	RCALL __EEPROMWRB
; 0000 00B0             }
	...
	RJMP _0xC
_0xD:
; 0000 00B1             // Nuevas Instrucciones
; 0000 00B2             PORTC.0 = 1;
	SBI  0x15,0
; 0000 00B3             completed = 0;
	CLT
	BLD  R15,0
; 0000 00B4             i = 0;
	RCALL SUBOPT_0x0
; 0000 00B5 
; 0000 00B6             while (!completed) {
_0x10:
	SBRC R15,0
	RJMP _0x12
; 0000 00B7                /* Boton arriba */
; 0000 00B8                if(b_arr == 0) {
	SBIC 0x16,5
	RJMP _0x13
; 0000 00B9                    b_arr_a = 0;
	CLT
...
_0x38:
	BLD  R3,1
; 0000 00BC                }
; 0000 00BD                if((b_arr_p == 1) && (b_arr_a == 0))// Cambio de flanco de 1 a 0
	SBRS R3,0
	RJMP _0x16
	SBRS R3,1
	RJMP _0x17
...
_0x17:
; 0000 00BE                {
; 0000 00BF                    // Guardamos un 1 para la izquierda
; 0000 00C0                    memory[i] = INST_ARR;
	RCALL SUBOPT_0x1
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x3
; 0000 00C1                    i++;
; 0000 00C2                    delay_ms(40); //Se coloca retardo de 40 ms para eliminar rebotes
	RCALL SUBOPT_0x4
; 0000 00C3                }
; 0000 00C4                b_arr_p=b_arr_a;
_0x15:
	BST  R3,1
	BLD  R3,0
; 0000 00C5 
; 0000 00C6                /* Boton abajo */
; 0000 00C7                if(b_abj == 0) {
	SBIC 0x16,6
	RJMP _0x18
; 0000 00C8                    b_abj_a = 0;
	CLT
...
_0x39:
	BLD  R3,3
; 0000 00CB                }
; 0000 00CC                if((b_abj_p == 1) && (b_abj_a == 0))// Cambio de flanco de 1 a 0
	SBRS R3,2
	RJMP _0x1B
	SBRS R3,3
	RJMP _0x1C
...
_0x1C:
; 0000 00CD                {
; 0000 00CE                    // Guardamos un 1 para la izquierda
; 0000 00CF                    memory[i] = INST_ABJ;
	RCALL SUBOPT_0x1
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x3
; 0000 00D0                    i++;
; 0000 00D1                    delay_ms(40); //Se coloca retardo de 40 ms para eliminar rebotes
	RCALL SUBOPT_0x4
; 0000 00D2                }
; 0000 00D3                b_abj_p=b_abj_a;
_0x1A:
	BST  R3,3
	BLD  R3,2
; 0000 00D4 
; 0000 00D5 
; 0000 00D6                /* Boton izquierdo */
; 0000 00D7                if(b_izq == 0) {
	SBIC 0x16,4
	RJMP _0x1D
; 0000 00D8                    b_izq_a = 0;
	CLT
...
_0x3A:
	BLD  R2,7
; 0000 00DB                }
; 0000 00DC                if((b_izq_p == 1) && (b_izq_a == 0))// Cambio de flanco de 1 a 0
	SBRS R2,6
	RJMP _0x20
	SBRS R2,7
	RJMP _0x21
...
_0x21:
; 0000 00DD                {
; 0000 00DE                    // Guardamos un 3 para la izquierda
; 0000 00DF                    memory[i] = INST_IZQ;
	RCALL SUBOPT_0x1
	LDI  R30,LOW(3)
	RCALL SUBOPT_0x3
; 0000 00E0                    i++;
; 0000 00E1                    delay_ms(40); //Se coloca retardo de 40 ms para eliminar rebotes
	RCALL SUBOPT_0x4
; 0000 00E2                }
; 0000 00E3                b_izq_p=b_izq_a;
_0x1F:
	BST  R2,7
	BLD  R2,6
; 0000 00E4 
; 0000 00E5 
; 0000 00E6                 /* Boton derecho */
; 0000 00E7                if(b_der == 0) {
	SBIC 0x16,3
	RJMP _0x22
; 0000 00E8                    b_der_a = 0;
	CLT
...
_0x3B:
	BLD  R2,5
; 0000 00EB                }
; 0000 00EC                if((b_der_p == 1) && (b_der_a == 0))// Cambio de flanco de 1 a 0
	SBRS R2,4
	RJMP _0x25
	SBRS R2,5
	RJMP _0x26
...
_0x26:
; 0000 00ED                {
; 0000 00EE                    // Guardamos un 1 para la izquierda
; 0000 00EF                    memory[i] = INST_DER;
	RCALL SUBOPT_0x1
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x3
; 0000 00F0                    i++;
; 0000 00F1                    delay_ms(40); //Se coloca retardo de 40 ms para eliminar rebotes
	RCALL SUBOPT_0x4
; 0000 00F2                }
; 0000 00F3                b_der_p=b_der_a;
_0x24:
	BST  R2,5
	BLD  R2,4
; 0000 00F4 
; 0000 00F5                if (i == MEM_SIZE) {
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CP   R30,R16
	CPC  R31,R17
	BRNE _0x27
; 0000 00F6                    completed = 1;
	SET
	BLD  R15,0
; 0000 00F7                    PORTC.0 = 0;
	CBI  0x15,0
...
; 0000 00FA 
; 0000 00FB         }
; 0000 00FC         b_clr_and_save_p=b_clr_and_save_a;
_0x8:
	BST  R2,1
	BLD  R2,0
; 0000 00FD 
; 0000 00FE         /* Empezar */
; 0000 00FF         if(b_start == 0) {
	SBIC 0x16,1
	RJMP _0x2A
; 0000 0100             b_start_a = 0;
	CLT
	RJMP _0x3C
; 0000 0101          } else {
_0x2A:
; 0000 0102             b_start_a = 1;
	SET
_0x3C:
	BLD  R2,3
; 0000 0103          }
; 0000 0104          if ((b_start_p==1)&&(b_start_a==0)) {
	SBRS R2,2
	RJMP _0x2D
	SBRS R2,3
	RJMP _0x2E
...
; 0000 0105             PORTC.1 = 1;
	SBI  0x15,1
; 0000 0106             for (i = 0 ; i < MEM_SIZE; i++) {
	RCALL SUBOPT_0x0
_0x32:
	__CPWRN 16,17,10
	BRGE _0x33
; 0000 0107                 PORTA = memory[i];
	RCALL SUBOPT_0x1
	RCALL __EEPROMRDB
	OUT  0x1B,R30
