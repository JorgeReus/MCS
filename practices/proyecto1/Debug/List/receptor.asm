...
; 0000 009F             PORTD = var;
	LDS  R30,_var
	OUT  0x12,R30
; 0000 00A0             var++; //Se incrementa la variable
	LDI  R26,LOW(_var)
	LDI  R27,HIGH(_var)
	RCALL SUBOPT_0x0
; 0000 00A1              delay_ms(40);
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A2           }
...
_0xB:
	...
	__CPD2N 0x3A98
	BRNE _0xE
; 0000 00A6             //aux = var / 10;
; 0000 00A7             //var=0;
; 0000 00A8             //PORTD.1 = ~PORTD.1;
; 0000 00A9             //PORTD = var;
; 0000 00AA             contador = 0;
	LDI  R30,LOW(0)
	STS  _contador,R30
	STS  _contador+1,R30
	STS  _contador+2,R30
