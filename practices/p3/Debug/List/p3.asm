...
; 0000 001F unsigned char variableA;
; 0000 0020 const char tabla7segmentos [10]={0x3f,0x06,0x5b,0x4f,0x66,0x6d,0x7c,0x07,0x7f,0x6f};
; 0000 0021 
...
; 0000 0031 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 0032 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
...
_0x4:
; 0000 0089       {
; 0000 008A        variable=PIND&0x0f; //Enmascaramos los 4 bits menos significativos
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R17,R30
; 0000 008B         variableA=PINC&0x0f;
	IN   R30,0x13
	ANDI R30,LOW(0xF)
	MOV  R16,R30
; 0000 008C         //del puerto A ya que los demás no interesan.
; 0000 008D 
; 0000 008E         if (variable<10)
	CPI  R17,10
	BRSH _0x7
; 0000 008F 
; 0000 0090         PORTB=tabla7segmentos[variable];
	MOV  R30,R17
	RCALL SUBOPT_0x0
	OUT  0x18,R30
; 0000 0091 
; 0000 0092         if (variable>=10) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
_0x7:
	CPI  R17,10
	BRLO _0x8
; 0000 0093 
; 0000 0094         PORTB=0x79;
	LDI  R30,LOW(121)
	OUT  0x18,R30
; 0000 0095 
; 0000 0096         if (variableA<10)
_0x8:
	CPI  R16,10
	BRSH _0x9
; 0000 0097 
; 0000 0098         PORTA=~tabla7segmentos[variableA];
	MOV  R30,R16
	RCALL SUBOPT_0x0
	COM  R30
	OUT  0x1B,R30
; 0000 0099 
; 0000 009A         if (variableA>=10) //Si lo que leemos es mayor o igual de 10 que dibuje en el display una E de ERROR
_0x9:
	CPI  R16,10
	BRLO _0xA
; 0000 009B 
