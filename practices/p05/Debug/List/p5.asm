...
_0xD:
	BLD  R2,1
; 0000 008E       if ((botona==0)&&(botonp==1)) //hubo cambio de flanco de 1 a 0
	SBRC R2,1
	RJMP _0x9
	SBRC R2,0
	RJMP _0xA
_0x9:
	RJMP _0x8
_0xA:
; 0000 008F             var++; //Se incrementa la variable
	INC  R5
; 0000 0090       if (var==10)
_0x8:
	LDI  R30,LOW(10)
...
; 0000 0091         var=0;
	CLR  R5
; 0000 0092         PORTB=tabla7segmentos [var];
_0xB:
	MOV  R30,R5
	LDI  R31,0
