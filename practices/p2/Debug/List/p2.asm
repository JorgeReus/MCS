...
; 0000 0089       PORTB++; //incrementa valor de puerto
	IN   R30,0x18
	SUBI R30,-LOW(1)
	OUT  0x18,R30
; 0000 008A       PORTD--; //incrementa valor de puerto
	IN   R30,0x12
	SUBI R30,LOW(1)
	OUT  0x12,R30
; 0000 008B       delay_ms(250); //retardo que se genera para visualizar la información
	LDI  R26,LOW(250)
	LDI  R27,0
	RCALL _delay_ms
; 0000 008C       }
